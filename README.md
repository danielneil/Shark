...
It enables the use of (multiple simultaneous) programmable strategies to identify and execute upon trading opportunities coupled with integrated backtesting components. 
