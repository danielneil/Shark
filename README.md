...
It enables the use of (multiple simultaneous) programmable strategies to identify and execute upon trading opportunities, coupled with integrated backtesting and nonrepudiation components. 
...
<table>
 <tr>
   <td style="font-weight: bold">Stock Listing</td>
