		...
		<ul class="navsectionlinks">
			...
			<li>
				...
				<ul>
					...
					<li><a href="http://{{ hostvars['shark']['ansible_eth0']['ipv4']['address'] }}:82/-/ide/project/root/shark/tree/master/-/backtest_moving_averages.py/" target="<?php echo $link_target;?>">Development</a></li>
				</ul>
			</li>
		</ul>
	</div>
