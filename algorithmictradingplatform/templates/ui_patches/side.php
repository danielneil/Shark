		...
		<ul class="navsectionlinks">
			...
			<li>
				...
				<ul>
					...
					<li><a href="http://{{ hostvars['shark-monitoring']['ansible_eth0']['ipv4']['address'] }}:82/-/ide/project/root/shark/tree/master/-/backtest_moving_averages.py/" target="<?php echo $link_target;?>">Development</a></li>
				</ul>
			</li>
		</ul>
	</div>
...
<div class="navsection">
	...
	<div class="navsectionlinks">
		<ul class="navsectionlinks">
			...
			<li><a href="http://<?php echo $_SERVER['SERVER_ADDR']; ?>/shark" target="_blank">Shark Directory</a></li>
